 ...
 * 
 * @author 5조
 * 교사_로그인 한 교사 의 강의스케줄 관련 클래스 입니다. 
 *
 */
public class Teacher2 {
   ...
   /**
    * 로그인 한 교사가 강의하는 과목의 이름, 진행여부를 출력하는 메소드입니다.
    */
   ...
   private static void T_schedule_info() {
      ...
      /**
       * 로그인 한 교사의 강의를 듣는 교육생 정보 출력 메소드입니다.
       * 	- 이름, 전화번호, 등록일, 수료여부가 출력됩니다.
       */
      ...
      /**
       * 로그인 한 교사의 강의스케줄 정보 출력 메소드입니다.
       * 	- 과정번호, 과정이름, 과정기간, 강의실이름, 인원수, 과목번호, 과목명, 과목기간, 교재명이 출력됩니다.
       */
