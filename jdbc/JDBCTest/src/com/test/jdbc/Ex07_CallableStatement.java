...
public class Ex07_CallableStatement {
	...
	public static void main(String[] args) {
		...
		//1. Statement : 정적 쿼리
		//2. PreparesStatement : 동적 쿼리 (매개변수)
	...
	private static void m4() {
		...
		try {
			...
			rs = (ResultSet)stat.getObject(2); // corsor == resultset
	...
	private static void m2() {
		...
		try {
			...
			stat.registerOutParameter(2, OracleTypes.VARCHAR); //out
	...
	private static void m1() {
		...
		//PreparesStatement(Text) = CallableStatement(Procedure)
