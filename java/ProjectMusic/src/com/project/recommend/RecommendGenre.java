...
/*
	...
	*/
	...
	static String singNumchoice(Scanner scan, List<HashMap<String, String>> pList) {
...
//		return title + "-" + singer ;
	...
	//전체 회원의 좋아하는 장르 찾기
	public static String getAllFavoritGan() {		//List 불러오기
		List<String> genres1 = rcmMusicListMain.getL1Genres();
		List<String> genres2 = rcmMusicListMain.getL2Genres();
		...
		String allFavoritGan = maxEntry.getKey();
		
		return allFavoritGan;
