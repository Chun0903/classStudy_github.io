...
public class Ex48_Lambda_basic {
	...
	public static void main(String[] args) {
		...
		// - 컬랙션을 사용하는 기능에 많이 지원하고 있음
		
		//람다식 기본 표현(문법)
		// - (자료형 매개변수) -> {실행코드};		//-> : 진짜 문법 화살표....
		...
		// 3. 람다식을 저장하는 인터페이스를 '함수형 인터페이스(Functional Interface)' 라고 한다.
...
interface MyInterface {
	void test();
//	void call();				//메소드 2개 만들면 람다식 사용 불가능 하나만!!!
}
