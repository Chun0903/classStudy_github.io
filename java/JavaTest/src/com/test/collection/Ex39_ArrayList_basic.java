...
//		list2.add("홍길동")
	...
	private static void m1() {
		...
		//ArrayList 컬렉션
		// - 선언 : 타입 명시(X) + 길이 명시(X)
		ArrayList nums2 = new ArrayList() ; //ArrayList is a raw type.
		...
		//***절대 금지!! > Object  저장 공간은 처음에 제이터를 넣을 때 자유  > 처음 데이터 넣고 난 후 부터는 절대적으로 처음과 같은 자료형만 넣을것!!!
//		nums2.add("홍길동");
//		nums2.add("아무개");
...
//		System.out.println(nums2.get(5)); // index 에러 //java.lang.IndexOutOfBoundsException
		
		System.out.println(nums2.size());//배열의 길이 역할
