...
public class Ex47_Collection_basic {
	...
	private static void m8() {
		...
		System.out.println(map.firstEntry()); //Entry -> Map의 요소
	...
	private static void m6() {
		...
		Set<MMouse> cset = new HashSet<MMouse>();
		
		cset.add(new MMouse("M700", 3));
		cset.add(new MMouse("S500", 5));
		cset.add(new MMouse("A1000", 7));
		cset.add(new MMouse("M700", 3)); 	//중복값X
		...
		//1. 주소값 : 다른 마우스
		//2. 상태값 : 같은 마우스
		MMouse m1 = new MMouse("M700", 3);
		MMouse m2 = new MMouse("M700", 3);
		MMouse m3 = new MMouse("A1000", 7);
