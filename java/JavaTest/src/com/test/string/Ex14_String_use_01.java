...
//		m8();
	...
	public static void m9() {
		...
		//1. 파일명 추출 -> Hello.java
		int index = path.lastIndexOf("\\"); //오른쪽에서 왼쪽으로
//		System.out.println(index);
	...
	public static void m7() {
		...
		System.out.println(word1.toUpperCase().equals(word3.toUpperCase()));
		
		
		String txt = "안녕하세요 저는 Java를 공부합니다.";
		String word = "java";
		
		//if(txt.indexOf(word) > -1) { 								//검색률 낮음, 정밀동 높음
	...
	public static void m6() {
		String txt = "안녕하세요. 홍길동 입니다. 반갑습니다. 홍길동 입니다. 다시 홍길동 입니다.";
		String word = "홍길동";
		int index = -1;
