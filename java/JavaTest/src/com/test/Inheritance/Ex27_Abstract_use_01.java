...
public class Ex27_Abstract_use_01 {
	...
	public static void main(String[] args) {
		...
		//3. 정검 사항 > 각 제품 본연 기능 테스트
		
		//m2() vs m4()
		// - 제품 고유 기능을 자주 사용 + 배열 -> m2() : 해당 타입 배역
		//		- 배열의 개수가 많아진다.
...
//부모 클래스
//회사 or 모델에 상관 없이 모든 프린터라고 불리는 기기들이 가져야할 공통사항을 정의하기 위한 클래스
// -  이름 동일 + 행동 다른 메소드가 필요 -> 추상 메소드
abstract class Printer {

	// 구현 멤버
	// - 모든 프린터 기기에게 동일하 기능을 상송
	public String model;
	public int price;
	public int ink;
...
class LG300 extends Printer {
	...
	public void print() {
		// 출력 + LG만의 독자적인 기술 구형
		System.out.println("LG300으로 레이져 출력을 합니다.");
	}
	//LG300만이 가지는 특화된 기능
