...
public class Ex08_Method_basic { //K&R
	...
	public static void main(String[] args) { //K&R 
	//{ Allman
	...
	*/
	...
	//에러(Erorr), 오류, 예외(Exception), 버그(Bug) 
	//에러의 종류
	//1. 컴파일 오류
	// - 컴파일 과정에서 발견되는 오류
...
//	System.out.printf("100 / %d = %d\n", num, 100 / num);
	...
	// - 메소드가 매개변수의 구성을 다양한 형태로 가질수 있게 하는 기술
	...
	//test(10, 20);				//6.
	//test(10, "문자열");		//7.
	//int result = test(10);	//8.
	
	//메소드를 만드는 중..
	//1. public static void test() 		{}			 //O
	//2. public static void test() 		{} 			 //X, 1. test()
	//3. public static void test(int n) {} 	    	 //O
	//4. public static void test(int m) {}		 	 //X, 3. test(int n)
	...
	//Duplicate method hello() in type Ex08_Mothod_basic
	// - 동일한 메소드 존재
